...
class Text:
    ...
    def draw(self):
        self.font.render_to(self.app.screen, (WIN_W * 0.595, WIN_H * 0.02),
                            text ='KNOTZ', fgcolor='white', 
                            size=TILE_SIZE *1.65, bgcolor='black')
        self.font.render_to(self.app.screen, (WIN_W * 0.595, WIN_H * 0.10),
        ...
        self.font.render_to(self.app.screen, (WIN_W * 0.64, WIN_H * 0.67),
                            ...
                            size=TILE_SIZE *1.4, bgcolor='black')
        self.font.render_to(self.app.screen, (WIN_W * 0.69, WIN_H * 0.8),
...
class Tetris:
    def __init__(self,app):
        ...
        self.score = 0
        self.full_lines = 0
        self.points_per_lines = {0: 0, 1: 100, 2: 300, 3: 750, 4: 1500}
